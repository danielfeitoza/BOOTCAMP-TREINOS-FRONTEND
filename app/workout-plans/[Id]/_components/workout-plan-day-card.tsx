...
export function WorkoutPlanDayCard({
  ...
  return (
    <Link
      ...
      className="relative flex h-50 w-full flex-col items-start justify-between overflow-hidden rounded-xl p-5"
    >
      {coverImageUrl ? (
        <Image
          src={coverImageUrl}
      ...
      <span className="relative z-10 flex items-center gap-1 rounded-full bg-overlay-foreground/16 px-2.5 py-1.5 backdrop-blur-sm">
